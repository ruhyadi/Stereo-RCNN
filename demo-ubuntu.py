...
def parse_args():
  ...
  parser.add_argument('--left_path', dest='left_path',
                      help='path to left images/images_2', default="demo/left/",
                      type=str)
  parser.add_argument('--right_path', dest='right_path',
                      help='path to right images/images_3', default="demo/left/",
                      type=str)
  parser.add_argument('--calib_path', dest='calib_path',
                      help='path to calibration', default="demo/calib/calib.txt",
                      type=str)
...
if __name__ == '__main__':
  ...
  with torch.no_grad():
    ...
    while True:
      # read data
      img_l_path = '/home/ruhyadi/capstone/demo/left/left.png'
      img_r_path = '/home/ruhyadi/capstone/demo/right/right.png'
